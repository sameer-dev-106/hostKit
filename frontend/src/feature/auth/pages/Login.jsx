      ...
      <div className={styles.rightPanel}>
        <div className={styles.mobileLogo}>
          <div className={styles.mobileLogoIcon}>
           ...
           <span><img src="/hostkit-logo-text-white.png" alt="HostKit" style={{ height: '28px', width: 'auto' }} /></span>
        </div>

        <div className={styles.formWrapper}>
          <div className={styles.heading}>
            <h1>Welcome back</h1>
            <p>Sign in to your HostKit account</p>
          </div>
          ...
          <div className={styles.oauthRow}>
            ...
            <button className={styles.githubBtn} onClick={handleGithubLogin} type="button">
              <GithubIcon /> GitHub
            </button>
          </div>
