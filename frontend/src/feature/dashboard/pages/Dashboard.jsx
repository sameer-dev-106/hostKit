      ...
      <div className={styles.cardTop}>
        ...
        <div className={styles.cardTitleRow}>
          ...
          <span className={styles.repoUrl}>
            {project.repoUrl || "No repo linked"}
          </span>
        </div>
...
function CreateProjectModal({ onClose, onSubmit, loading }) {
  ...
  const validate = () => {
    ...
    if (!form.repoUrl.trim()) e.repoUrl = "Repository URL is required";
      ...
      !/^https?:\/\/.+/.test(form.repoUrl) &&
      !form.repoUrl.startsWith("github.com")
    ) {
      e.repoUrl =
          ...
          <div className={styles.formGroup}>
            ...
            <div className={styles.inputWithIcon}>
              ...
              <input
                ...
                className={errors.repoUrl ? styles.inputError : ""}
              />
            </div>
            {errors.repoUrl && (
              <span className={styles.errorMsg}>{errors.repoUrl}</span>
            )}
            <span className={styles.fieldHint}>
              Make sure HostKit has access to this repository
            </span>
          </div>
    ...
    <div className={styles.dashboardRoot}>
      ...
      <aside className={styles.sidebar}>
        ...
        <div className={styles.sidebarBottom}>
          <button className={styles.navItemBottom}>
            <SupportIcon /> SUPPORT
          </button>
          <button className={styles.navItemBottom}>
          ...
          <div className={styles.centerPanel}>
            <div className={styles.pageHeader}>
              <div>
                ...
                <p>
                  Managing {projects.length} active deployment
                  {projects.length !== 1 ? "s" : ""}{" "}
                  {regionCount > 0 &&
            ...
            <div className={styles.insightsCard}>
              ...
              <div className={styles.insightsList}>
                {insights.length === 0 ? (
                  ...
                  insights.map((ins, i) => (
                    <div
                      key={ins._id || ins.id || i}
                      className={styles.insightItem}
                    >
                      <div
                        className={`${styles.insightIcon} ${styles[ins.type]}`}
                      >
            ...
            <div className={styles.resourceCard}>
              ...
              <div className={styles.resourceItem}>
                <div className={styles.resourceLabel}>
                  ...
                  <span>
                    {bwUsed} / {bwTotal}{" "}
                    {resourceUsage?.bandwidth?.unit ?? "TB"}
                  </span>
                </div>
              ...
              <div className={styles.resourceItem}>
                <div className={styles.resourceLabel}>
                  ...
                  <span>
                    {bmUsed.toLocaleString()} / {bmTotal.toLocaleString()}
                  </span>
                </div>
                <div className={styles.resourceTrack}>
                  <div
